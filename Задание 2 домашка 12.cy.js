describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('user_name');                   // вводим логин
         cy.get('input[id="k_password"]').type('user_rassword');               // вводим пароль
         ...
         cy.get('.card_name').type('Drey21');                           // вводим имя владельца действия карты
